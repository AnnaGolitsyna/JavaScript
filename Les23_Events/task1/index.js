// algo
// find DOM email, password, both Error +++
// create f valid => email, password +++
// if invalid => red border, massege about Error +++
// after submint => alert obj{'inpName: inpValue, ...}
...
const onFormSummit = event => {
  ...
  //   const formData = [...new FormData(formElem)].reduce((acc, [key, value]) =>  ({ ...acc, [key]: value }), {});
