// Algo
// input
// *setMessage - input /message/, output - und +++
// *setSender - input /sender/, output - und
// *sendMessage - input - /name/, output - und =>
//  'Hello, *name*! *message*! This message was sent by *sender*' +++
// output => {}
// export default function createMessenger() or
// *if const  1/ const createMessenger()...
//            2/ export default createMessenger;
